...
let winner;
    ...
    winner = fields[0];
    document.getElementById('line3').style.transform = 'scaleX(1.05)';
    }
    if (fields[1] == fields[4] && fields[4] == fields[7] && fields[1]) {
    winner = fields[1];
    document.getElementById('line4').style.transform = 'scaleX(1.05)';
    }
    if (fields[2] == fields[5] && fields[5] == fields[8] && fields[2]) {
    winner = fields[2];
    document.getElementById('line5').style.transform = 'scaleX(1.05)';
    }
